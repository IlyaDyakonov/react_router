...
export function Menu(): JSX.Element {
    ...
    return (
        <nav className="menu">
            <NavLink to={"/home"} className={active}>Главная</NavLink>
            <NavLink to={"/drift"} className={active}>Дрифт-такси</NavLink>
            <NavLink to={"/timeattack"} className={active}>Forza Karting</NavLink>
            <NavLink to={"/forza"} className={active}>​Time Attack</NavLink>
        </nav>
    );
}
